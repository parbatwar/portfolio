...
function SocialsCard() {
  ...
  const socialLinks = [
    {
      ...
      color: '#ffffff',
      brandBg: 'rgba(255,255,255,0.03)',
      span: 'col-span-2' // Core identity anchor
    },
    {
      name: 'LinkedIn',
    ...
    },
    {
      ...
      url: socialsData.instagramPersonal,
      color: '#E1306C',
    ...
    },
    {
      ...
      url: socialsData.instagramBrand,
      color: '#FCAF45',
      brandBg: 'rgba(252,175,69,0.1)',
      span: 'col-span-1'
    },
    {
      name: 'warbatmusic',
      icon: 'fab fa-soundcloud',
      url: socialsData.soundcloud,
      color: '#FF5500',
      brandBg: 'rgba(255,85,0,0.1)',
      span: 'col-span-1'
    },
    {
      name: 'Facebook',
      icon: 'fab fa-facebook-f',
      url: socialsData.facebook,
      color: '#1877F2',
  ...
  return (
    ...
    >
      {/* Background Subtle Global Spotlight */}
      <motion.div
      ...
      <div className="relative z-10 flex flex-col h-full justify-between gap-6">
        ...
        <div className="grid grid-cols-2 gap-2.5 my-auto">
          {socialLinks.map((social) => (
            ...
            >
              <div 
                className="w-7 h-7 rounded-lg flex items-center justify-center text-sm transition-transform duration-300 group-hover/social:scale-110"
        ...
        <div className="pt-3 border-t border-white/[0.03] flex items-center justify-between">
          ...
          <a 
            ...
            className="text-[11px] font-mono text-zinc-400 hover:text-emerald-400 transition-colors flex items-center gap-1 group/mail"
          >
            {socialsData.email} 
