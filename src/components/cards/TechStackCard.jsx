  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: useMotionTemplate`radial-gradient(250px circle at ${spotlightX}px ${spotlightY}px, rgba(16,185,129,0.08), transparent 80%)`,
        }}
      />

      <div className="relative z-10 flex flex-col h-full gap-4">
        <span className="text-[10px] font-mono tracking-widest text-emerald-400 uppercase">Tech Stack</span>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {skills.map((skill) => (
                ...
                >
                  <skill.icon style={{ color: skill.color }} className="text-sm" />
